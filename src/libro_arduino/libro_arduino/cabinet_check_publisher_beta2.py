...
class CabinetCheckPublisher(Node):
    def __init__(self):
        ...
        # API endpoint
        self.pickup_zones_url = "http://192.168.0.138:8000/pickup-zones/bulk-update"
    ...
    def save_cabinet_status(self):
        try:
            # Convert to array format as required
            status_array = [
                {
                    "pickup_place": "픽업존 A",
                    "P1": self.cabinet_status[0]["P1"],
                    "P2": self.cabinet_status[0]["P2"]
                },
                {
                    "pickup_place": "픽업존 B",
                    "P1": self.cabinet_status[1]["P1"],
                    "P2": self.cabinet_status[1]["P2"]
                }
            ]
