...
class RobotController(Node):
    ...
    def angle_callback(self, request, response):
        ...
        try:
            ...
            self.get_logger().info(f'Set angles to {angles} with speed {speed}')
        except Exception as e:
            response.success = False
    ...
    def pos_callback(self, request, response):
        ...
        try:
            ...
            self.get_logger().info(f'Set coordinates to {coords} with speed {speed} and mode {mode}')
        except Exception as e:
            response.success = False
